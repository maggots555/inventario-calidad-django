...
(function () {
    ...
    const EVENTOS_URL = (_a = document.body.dataset.eventosUrl) !== null && _a !== void 0 ? _a : '';
    /**
     ...
     */
    function registrarEvento(tipo, metadata = {}, unaVezPorSesion = false) {
        if (!EVENTOS_URL)
            return;
        if (unaVezPorSesion) {
