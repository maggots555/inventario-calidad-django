 ...
 */
function inicializarScannerModalEditarEquipo(): void {
  ...
  enlazar(
    'btnEscanearNumeroSerieModal',
    'id_numero_serie',
    'Escanear número de serie del equipo',
  );

  enlazar(
    'btnEscanearCargadorModal',
    'id_numero_serie_cargador_modal',
    'Escanear número de serie del cargador',
    {
