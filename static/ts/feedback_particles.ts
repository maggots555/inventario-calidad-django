...
(function () {
    ...
    // Cada punto de la malla tiene una posición "de casa" (homeX/homeY)
    // y una posición actual (x/y). El cursor empuja la actual; el resorte
    // la jala de vuelta a casa. Así la malla "ondula" y se recupera.
    interface MeshPoint {
        homeX: number;
        homeY: number;
        x: number;
