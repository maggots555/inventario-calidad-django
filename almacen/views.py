...
- Este archivo: SolicitudCotizacion / sync ST residuales + reexports
...
- views_compras.py: CompraProducto (lista, recibir, devoluciones, unidades)

urls.py sigue importando from . import views; los nombres extraídos
se reexportan al inicio de este módulo (Fase 0 .. Fase 3).
"""
...
# ============================================================================
# REEXPORTS (modularización Fase 0 + Fase 1 + Fase 2 + Fase 3)
# ============================================================================
# EXPLICACIÓN PARA PRINCIPIANTES:
