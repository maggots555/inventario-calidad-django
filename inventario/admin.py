...
class ProductoAdmin(admin.ModelAdmin):
    list_display = ('codigo_qr', 'nombre', 'categoria', 'cantidad', 'stock_minimo', 'stock_bajo', 'estado_calidad', 'fecha_ingreso')
    list_filter = ('categoria', 'tipo', 'estado_calidad', 'fecha_ingreso')
    search_fields = ('codigo_qr', 'nombre', 'descripcion', 'proveedor')
...
class MovimientoAdmin(admin.ModelAdmin):
    list_display = ('fecha_movimiento', 'producto', 'tipo', 'cantidad', 'motivo', 'destinatario', 'usuario_registro')
    list_filter = ('tipo', 'motivo', 'fecha_movimiento', 'sucursal_destino')
    search_fields = ('producto__nombre', 'producto__codigo_qr', 'destinatario', 'area_destino', 'usuario_registro')
