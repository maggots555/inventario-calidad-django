"""
Texto plano del correo de Formato de Servicio en Garantía Dell.

EXPLICACIÓN PARA PRINCIPIANTES:
================================
El HTML muestra el PDF firmado y los datos DPS. El text/plain debe
decir lo mismo por si Gmail/Outlook bloquean el HTML: qué documento
va adjunto, datos del equipo y a quién contactar.
"""
...
def construir_texto_plano_formato_garantia(context: dict) -> str:
    """
    Arma el cuerpo text/plain del correo de formato garantía Dell.

    Objetivo de negocio:
        El cliente recibe el PDF firmado aunque su bandeja bloquee HTML.

    Args:
        context: El mismo diccionario que `formato_garantia_cliente.html`.
    ...
    lineas = [
        'Formato de servicio garantía Dell',
        f'Orden (DPS): {orden_sicser}',
        '',
        'Buen día estimado usuario',
        '',
        (
            f"Me dirijo de {context.get('empresa_nombre') or ''} para enviarle el "
            'Formato de Servicio en Garantía Dell correspondiente a su equipo de '
            'cómputo. El documento firmado se encuentra adjunto en este correo.'
        ),
        '',
        ...
        '1 PDF — Formato de Servicio en Garantía Dell firmado',
        '',
        'INFORMACIÓN IMPORTANTE',
        'El documento PDF adjunto es el formato oficial de servicio en garantía firmado.',
        'Conserve este archivo para su expediente y seguimiento con Dell.',
