"""
Vista detalle_orden — shell principal de una orden (Fase B / Fase 10).

EXPLICACIÓN PARA PRINCIPIANTES:
--------------------------------
Esta vista es el "tablero" de una orden: muestra datos, procesa muchos
formularios POST (form_type) y arma el context del template.

Fase A: el template ya está partido en partials (includes).
Fase B (este archivo): la función salió de views.py sin cambiar lógica.
Fase C (pendiente): partir handlers form_type + context + JS inline.

urls.py sigue usando views.detalle_orden porque views.py reexporta este símbolo.
NO re-inflar este archivo con features nuevas: módulos hermanos / services/.
"""
...
# Logger: la vista lo usa en ramas de error / subida de multimedia.
