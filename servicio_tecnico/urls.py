...
urlpatterns = [
    ...
    # Reporte de embudo de conversión RHITSO (análisis + Excel)
    path('rhitso/exportar-analisis/', views.exportar_analisis_rhitso, name='exportar_analisis_rhitso'),
    ...
    path('orden/<int:orden_id>/formato-oow/reenviar-email/',
         views.formato_oow_reenviar_email,
         name='formato_oow_reenviar_email'),
